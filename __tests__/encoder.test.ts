  ...
  it("marshalBinary", () => {
    const stdTx = {
      msg: [
        {
          sender: Buffer.from([
            182, 86, 29, 204, 16, 65, 48, 5, 154, 124, 8, 244, 140, 100, 97, 12,
            31, 111, 144, 100,
          ]),
      ...
      signatures: [
        {
          pub_key: Buffer.from([
            235, 90, 233, 135, 33, 3, 186, 245, 61, 20, 36, 248, 234, 131, 208,
            58, 130, 246, 209, 87, 181, 64, 28, 78, 165, 127, 251, 131, 23, 135,
            46, 21, 161, 159, 201, 183, 173, 123,
          ]),
          signature: Buffer.from([
            231, 154, 102, 6, 210, 140, 240, 123, 156, 198, 245, 102, 181, 36,
            165, 40, 43, 19, 190, 204, 195, 22, 35, 118, 199, 159, 57, 38, 32,
            201, 90, 68, 123, 25, 246, 78, 118, 30, 34, 167, 163, 188, 49, 26,
            120, 14, 125, 159, 221, 82, 30, 47, 126, 222, 194, 83, 8, 197, 186,
            198, 170, 28, 10, 49,
          ]),
          account_number: 1,
          sequence: 10,
